########################################################################################################################
#!!
#! @description: Get details of workspace in an organization.
#!
...
#!                                Optional
#!
#! @output return_result: Workspace details in response
#! @output exception: An error message in case there was an error while creating the message.
#! @output status_code: The HTTP status code for Terraform API request.
#! @output workspace_id: The Id of the workspace
#!
...
operation: 
  ...
  java_action: 
    gav: 'io.cloudslang.content:cs-hashicorp-terraform:1.0.0-RC13'
    class_name: 'io.cloudslang.content.hashicorp.terraform.actions.workspaces.GetWorkspaceDetails'
    method_name: 'execute'
